  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        ...
        if ($link == 'editAuction') {
          include '../components/adminuser/editAuction.php';
        }
        if ($link == 'delAuction') {
          include '../components/adminuser/delAuction.php';
        }
        if ($link == 'auctionList') {
           include '../components/adminuser/auctionList.php';
        }

        if ($link == 'editPost') {
          include '../components/adminuser/editPost.php';
        }
        if ($link == 'delPost') {
          include '../components/adminuser/delPost.php';
        }
        if ($link == 'postList') {
           include '../components/adminuser/postList.php';
        }
